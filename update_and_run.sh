...
git pull origin main >> /home/pi/Desktop/OP-Crime/logs/update_repo.log 2>&1
...
python  OakPark_Crime_Reporting_Web.py >> /home/pi/logs/OakPark_Crime_Reporting_Web.log 2>&1
